...
async def generate_chat_completion(
    ...
    payload['metadata'] = {
        "job_id": metadata.get("job_id", "NA"),
        "chat_id": metadata.get("chat_id", "NA")
    }
    ...
    try:
        ...
        url1 = f"http://localhost:9999/chat/completions"
        url2 = f"{url}/chat/completions"
        ...
        # r = await abotai_request(payload)
